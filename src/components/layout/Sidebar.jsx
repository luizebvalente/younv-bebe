                ...
                >
                  {isCollapsed ? (
                    ...
                    <>
                      ...
                      <div className="absolute left-full ml-2 px-3 py-2 bg-gray-800 text-white text-sm rounded-md hidden group-hover:block pointer-events-none whitespace-nowrap z-50 shadow-lg">
