...
export default function Leads() {
  ...
  const [formData, setFormData] = useState(() => ({
    ...
    quais_profissionais: '',
    // NOVOS CAMPOS PARA OUTROS PROFISSIONAIS (5 slots)
                          ...
                          <div className="space-y-2">
                            ...
                            <Select value={formData.status} onValueChange={(value) => handleFormChange('status', value)}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="Follow 1">Follow 1</SelectItem>
                                <SelectItem value="Follow 2">Follow 2</SelectItem>
                                <SelectItem value="Follow 3">Follow 3</SelectItem>
                                <SelectItem value="Follow 7">Follow 7</SelectItem>
                              </SelectContent>
                            </Select>
                          </div>
                        </div>
